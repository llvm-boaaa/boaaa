...
void DLInterface71::onLoad()
{
	registerPasses();
	context.string_ref_vp = new StringRefVP71();
}

void DLInterface71::onUnload()
{
	delete context.string_ref_vp;
}

void DLInterface71::registerStringRefVPM(StringRefVPM* manager)
{
	context.string_ref_vp->registerVPM(manager);
}

void DLInterface71::setBasicOStream(std::ostream& ostream, bool del)
{
...
boaaa::cl_aa_store DLInterface71::getAvailableAAs()
{
	return boaaa::getInitalizedAAs_71();
}
...
bool DLInterface71::loadModule(uint64_t module_file_hash)
{
...
bool DLInterface71::loadModule(uint64_t module_file_prefix, uint64_t module_file_hash)
{
...
void DLInterface71::unloadModule()
{
...
bool DLInterface71::runAnalysis(boaaa::aa_id analysis)
{
...
bool DLInterface71::runAnalysis(boaaa::aa_id analysis, EvaluationResult& er)
{
	auto run = [&](auto* pass) -> void {
		llvm::legacy::PassManager pm;
		pass->setContext(&context, analysis);
...
void DLInterface71::test(uint64_t* hash, uint8_t num)
{
